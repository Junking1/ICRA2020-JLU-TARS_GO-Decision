#ifndef ROBORTS_DECISION_GAINBLOODACTION_H
#define ROBORTS_DECISION_GAINBLOODACTION_H
#include <unistd.h>      
#include <ros/ros.h>
...
class GainBloodAction : public ActionNode {
    public:
        GainBloodAction(const Blackboard::Ptr &blackboard_ptr, GoalFactory::GoalFactoryPtr &goal_factory_ptr) :
                ActionNode::ActionNode("gain_blood_buff_action", blackboard_ptr), goal_factory_ptr_(goal_factory_ptr) {
                    chassis_executor_ptr_ = blackboard_ptr_->GetChassisExecutor();
                }
        virtual ~GainBloodAction() = default;
    ...
    private:
        ...
        virtual BehaviorState Update() {
	        ...
	        //goal_factory_ptr_->BuffGoal(0);
            goal_factory_ptr_->BuffGoal();
            ROS_INFO("to gain blood buff ！");
...
#endif
//ROBORTS_DECISION_GAINBLOODACTION_H